...
/** Occupation section for the Profile page's Business tab. Deliberately
 * not a wizard step -- onboarding stays at 3 steps. 'Job' reveals
 * title/company/location; 'Business' points at the listings editor that
 * sits right below it on the same tab. */
    ...
    <div className="flex flex-col gap-4">
      ...
      {isBusiness && (
        <p className="text-sm text-[var(--color-text-muted)]">
          Add your businesses below so other members can find them.
        </p>
      )}
    </div>
  )
